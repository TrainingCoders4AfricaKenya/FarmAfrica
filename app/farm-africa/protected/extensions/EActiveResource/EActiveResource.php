...
/**
 * Active resource is meant to be used similar to an ActiveRecord model in Yii. In difference to ActiveRecord
...
abstract class EActiveResource extends CModel {
     ...
     * @return EActiveResourceConnection The connection component as specified in the config
     */
